    ...
    >
      ...
      {enableLegendSlider && (hasScroll?.right || hasScroll?.left) ? (
        <>
          <div
            className={tremorTwMerge(
              "absolute top-0 bottom-0 left-0 w-4 bg-gradient-to-r from-white dark:from-transparent to-transparent pointer-events-none",
            )}
          />
          <div
            className={tremorTwMerge(
              "absolute top-0 bottom-0 right-10 w-4 bg-gradient-to-r from-transparent to-white dark:to-transparent pointer-events-none",
            )}
          />
          <div
            className={tremorTwMerge(
